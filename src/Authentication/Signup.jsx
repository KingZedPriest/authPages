    ...
    <div className="bg-[#F0F0F0] h-screen flex items-center justify-center">
      <main className="text-black">
        <div className="bg-white p-8 rounded-2xl w-[20rem] sm:w-[24rem] md:w-[28rem] lg:w-[32rem] shadow-lg">
            ...
            <div className="mt-16 w-full flex flex-col">
              <div className="flex flex-col lg:flex-row items-center justify-between">
                <div className="w-full lg:w-[48%]">
                  <label
                    className="text-xs block sm:text-sm font-bold"
                    htmlFor="firstName"
                  >
                    First Name
                  </label>
                ...
                <div className="w-full lg:w-[48%]">
                  <label
                    className="text-xs mt-4 lg:mt-0 block sm:text-sm font-bold"
                    htmlFor="lastName"
                  >
                    Last Name
                  </label>
          ...
          <div className="py-8">
            <p className="text-xs lg:text-sm text-gray-400">Have An Account? <Link className="text-[#793FDF] cursor-pointer font-semibold" to="/signin"> Sign in</Link></p>
          </div>
        </div>
      </main>
    </div>
